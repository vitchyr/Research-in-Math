...
#Labels:
plt.scatter(x1,y1, c='b', label='slope = ')# + '%.3f' % slope1)
##plt.scatter(x2,y2, c='g', label=r'$\alpha$ = 2, slope = ' + '%.3f' % slope2)
plt.ylabel(headers[1])
plt.xlabel(headers[0])
##plt.xlabel("$Log(" + headers[0] +")$")
#TODO: name plot title
plt.title(r'Mean Pair-Wise Distance in Giant Component, d = 1, $\alpha$ = 1')
plt.legend(loc=4)
